...
CREATE TABLE `bank_customer` (
	...
	`c_phone`CHAR(20)		UNIQUE KEY NOT NULL,
	`c_addr`	VARCHAR(100)DEFAULT NULL
	);
	
CREATE TABLE `bank_account` (
	`a_no`			CHAR(11) 	PRIMARY KEY NOT NULL,
...
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-1001', 1, 50000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-1003', 2, 120000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-2001', 2, 300000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-12-1002', 1, 1000000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-1001', 3, 0, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-13-1005', 1, 200000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-1001', 1, 450000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-2002', 2, 32000, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-2003', 3, 0, NOW());
INSERT INTO `bank_transaction` (`t_a_no`, `t_dist`, `t_amount`, `t_datetime`)VALUE('101-11-1003', 1, 75000, NOW());
...
#실습 2-16
SELECT MAX(`t_amount`)`큰 금액`, MIN(`t_amount`)`작은금액`FROM `bank_transaction` WHERE `t_dist` = 2;
#실습 2-17
SELECT FROM `bank_accoint` WHERE `a_items_dist` ='S1' ORDER BY `a_balance` DESC;
#실습 2-18
...
SELECT
	...
	COUNT(if(`t_dist` = 3), 1, 0)AS `조회 건수` FROM `bank_transaction`;
#실습 2-21
SELECT `t_dist`, 
		CASE
		...
		END AS 'type',
		`t_a_no`,
		`t_amount` FROM `bank_transaction`;
#실습 2-22
